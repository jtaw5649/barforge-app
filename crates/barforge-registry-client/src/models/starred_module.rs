...
impl StarredModule {
    pub fn new(uuid: String, name: String, description: String, author: String, category: models::ModuleCategory, repo_url: String, downloads: i64, verified_author: bool, tags: Vec<String>, starred_at: String) -> StarredModule {
        StarredModule {
            uuid,
            name,
            description,
