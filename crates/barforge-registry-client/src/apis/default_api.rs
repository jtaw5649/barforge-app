...
pub async fn api_v1_admin_stats_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1AdminStatsGet200Response, Error<ApiV1AdminStatsGetError>> {
...
pub async fn api_v1_admin_submissions_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1AdminSubmissionsGet200Response, Error<ApiV1AdminSubmissionsGetError>> {
...
pub async fn api_v1_admin_submissions_id_approve_post(configuration: &configuration::Configuration, id: i32) -> Result<String, Error<ApiV1AdminSubmissionsIdApprovePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/api/v1/admin/submissions/{id}/approve", configuration.base_path, id=p_path_id);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1AdminSubmissionsIdApprovePostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_admin_submissions_id_reject_post(configuration: &configuration::Configuration, id: i32, reject_request: models::RejectRequest) -> Result<String, Error<ApiV1AdminSubmissionsIdRejectPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_reject_request = reject_request;

    let uri_str = format!("{}/api/v1/admin/submissions/{id}/reject", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1AdminSubmissionsIdRejectPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_admin_users_id_verify_post(configuration: &configuration::Configuration, id: i32) -> Result<models::ApiV1AdminUsersIdVerifyPost200Response, Error<ApiV1AdminUsersIdVerifyPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/api/v1/admin/users/{id}/verify", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn api_v1_auth_sync_post(configuration: &configuration::Configuration, ) -> Result<models::ApiV1AuthSyncPost200Response, Error<ApiV1AuthSyncPostError>> {
...
pub async fn api_v1_auth_verify_get(configuration: &configuration::Configuration, ) -> Result<models::AuthVerifyResponse, Error<ApiV1AuthVerifyGetError>> {
...
pub async fn api_v1_categories_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1CategoriesGet200Response, Error<ApiV1CategoriesGetError>> {
...
pub async fn api_v1_collections_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1CollectionsGet200Response, Error<ApiV1CollectionsGetError>> {
...
pub async fn api_v1_collections_id_delete(configuration: &configuration::Configuration, id: i32) -> Result<String, Error<ApiV1CollectionsIdDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn api_v1_collections_id_get(configuration: &configuration::Configuration, id: i32) -> Result<models::ApiV1CollectionsIdGet200Response, Error<ApiV1CollectionsIdGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn api_v1_collections_id_modules_post(configuration: &configuration::Configuration, id: i32, add_module_request: models::AddModuleRequest) -> Result<String, Error<ApiV1CollectionsIdModulesPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_add_module_request = add_module_request;

    let uri_str = format!("{}/api/v1/collections/{id}/modules", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1CollectionsIdModulesPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_collections_id_modules_uuid_delete(configuration: &configuration::Configuration, id: i32, uuid: &str) -> Result<String, Error<ApiV1CollectionsIdModulesUuidDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_path_uuid = uuid;

    let uri_str = format!("{}/api/v1/collections/{id}/modules/{uuid}", configuration.base_path, id=p_path_id, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1CollectionsIdModulesUuidDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_collections_id_patch(configuration: &configuration::Configuration, id: i32, update_collection_request: models::UpdateCollectionRequest) -> Result<String, Error<ApiV1CollectionsIdPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn api_v1_collections_post(configuration: &configuration::Configuration, create_collection_request: models::CreateCollectionRequest) -> Result<models::ApiV1CollectionsPost200Response, Error<ApiV1CollectionsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn api_v1_featured_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1FeaturedGet200Response, Error<ApiV1FeaturedGetError>> {
...
pub async fn api_v1_health_get(configuration: &configuration::Configuration, ) -> Result<String, Error<ApiV1HealthGetError>> {
...
pub async fn api_v1_index_get(configuration: &configuration::Configuration, ) -> Result<models::RegistryIndex, Error<ApiV1IndexGetError>> {
...
pub async fn api_v1_landing_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1LandingGet200Response, Error<ApiV1LandingGetError>> {
...
pub async fn api_v1_modules_get(configuration: &configuration::Configuration, q: Option<&str>, category: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ApiV1ModulesGet200Response, Error<ApiV1ModulesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_q = q;
...
pub async fn api_v1_modules_mine_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1ModulesGet200Response, Error<ApiV1ModulesMineGetError>> {
...
pub async fn api_v1_modules_post(configuration: &configuration::Configuration, create_module_request: models::CreateModuleRequest) -> Result<models::ApiV1ModulesPost200Response, Error<ApiV1ModulesPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn api_v1_modules_search_get(configuration: &configuration::Configuration, q: Option<&str>, category: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ApiV1ModulesGet200Response, Error<ApiV1ModulesSearchGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_q = q;
    let p_query_category = category;
    let p_query_sort = sort;
...
pub async fn api_v1_modules_uuid_download_post(configuration: &configuration::Configuration, uuid: &str) -> Result<String, Error<ApiV1ModulesUuidDownloadPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/api/v1/modules/{uuid}/download", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn api_v1_modules_uuid_get(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiV1ModulesUuidGet200Response, Error<ApiV1ModulesUuidGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/api/v1/modules/{uuid}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn api_v1_modules_uuid_related_get(configuration: &configuration::Configuration, uuid: &str, limit: Option<i32>) -> Result<models::ApiV1ModulesGet200Response, Error<ApiV1ModulesUuidRelatedGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_query_limit = limit;

    let uri_str = format!("{}/api/v1/modules/{uuid}/related", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn api_v1_modules_uuid_reviews_delete(configuration: &configuration::Configuration, uuid: &str) -> Result<String, Error<ApiV1ModulesUuidReviewsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/api/v1/modules/{uuid}/reviews", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1ModulesUuidReviewsDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_modules_uuid_reviews_get(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiV1ModulesUuidReviewsGet200Response, Error<ApiV1ModulesUuidReviewsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn api_v1_modules_uuid_reviews_post(configuration: &configuration::Configuration, uuid: &str, create_review_request: models::CreateReviewRequest) -> Result<String, Error<ApiV1ModulesUuidReviewsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn api_v1_modules_uuid_reviews_put(configuration: &configuration::Configuration, uuid: &str, create_review_request: models::CreateReviewRequest) -> Result<String, Error<ApiV1ModulesUuidReviewsPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_body_create_review_request = create_review_request;
...
pub async fn api_v1_modules_uuid_screenshots_get(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiV1ModulesUuidScreenshotsGet200Response, Error<ApiV1ModulesUuidScreenshotsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/api/v1/modules/{uuid}/screenshots", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1ModulesUuidScreenshotsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_modules_uuid_screenshots_id_delete(configuration: &configuration::Configuration, uuid: &str, id: i32) -> Result<models::ScreenshotDeleteResponse, Error<ApiV1ModulesUuidScreenshotsIdDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_path_id = id;

    let uri_str = format!("{}/api/v1/modules/{uuid}/screenshots/{id}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid), id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1ModulesUuidScreenshotsIdDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_modules_uuid_screenshots_post(configuration: &configuration::Configuration, uuid: &str, body: std::path::PathBuf, alt_text: Option<&str>) -> Result<models::ScreenshotUploadResponse, Error<ApiV1ModulesUuidScreenshotsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1ModulesUuidScreenshotsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_modules_uuid_star_delete(configuration: &configuration::Configuration, uuid: &str) -> Result<String, Error<ApiV1ModulesUuidStarDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/api/v1/modules/{uuid}/star", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn api_v1_modules_uuid_star_get(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiV1ModulesUuidStarGet200Response, Error<ApiV1ModulesUuidStarGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn api_v1_modules_uuid_star_post(configuration: &configuration::Configuration, uuid: &str, star_request: Option<models::StarRequest>) -> Result<String, Error<ApiV1ModulesUuidStarPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn api_v1_modules_uuid_versions_get(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiV1ModulesUuidVersionsGet200Response, Error<ApiV1ModulesUuidVersionsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/api/v1/modules/{uuid}/versions", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn api_v1_modules_uuid_versions_version_publish_post(configuration: &configuration::Configuration, uuid: &str, version: &str, publish_request: models::PublishRequest) -> Result<models::ApiV1ModulesUuidVersionsVersionPublishPost200Response, Error<ApiV1ModulesUuidVersionsVersionPublishPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_path_version = version;
    let p_body_publish_request = publish_request;

    let uri_str = format!("{}/api/v1/modules/{uuid}/versions/{version}/publish", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid), version=crate::apis::urlencode(p_path_version));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1ModulesUuidVersionsVersionPublishPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_modules_uuid_versions_version_upload_post(configuration: &configuration::Configuration, uuid: &str, version: &str, content_length: i32, body: std::path::PathBuf) -> Result<models::ApiV1ModulesUuidVersionsVersionUploadPost200Response, Error<ApiV1ModulesUuidVersionsVersionUploadPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_path_version = version;
    ...
    let uri_str = format!("{}/api/v1/modules/{uuid}/versions/{version}/upload", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid), version=crate::apis::urlencode(p_path_version));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1ModulesUuidVersionsVersionUploadPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_notifications_announcements_post(configuration: &configuration::Configuration, announcement_request: models::AnnouncementRequest) -> Result<models::ApiV1NotificationsAnnouncementsPost200Response, Error<ApiV1NotificationsAnnouncementsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_announcement_request = announcement_request;

    let uri_str = format!("{}/api/v1/notifications/announcements", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1NotificationsAnnouncementsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_notifications_get(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>) -> Result<models::ApiV1NotificationsGet200Response, Error<ApiV1NotificationsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_offset = offset;
...
pub async fn api_v1_notifications_id_read_patch(configuration: &configuration::Configuration, id: i32) -> Result<models::ApiV1NotificationsIdReadPatch200Response, Error<ApiV1NotificationsIdReadPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/api/v1/notifications/{id}/read", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1NotificationsIdReadPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_notifications_mark_all_read_post(configuration: &configuration::Configuration, ) -> Result<models::ApiV1NotificationsMarkAllReadPost200Response, Error<ApiV1NotificationsMarkAllReadPostError>> {

    let uri_str = format!("{}/api/v1/notifications/mark-all-read", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1NotificationsMarkAllReadPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_notifications_preferences_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1NotificationsPreferencesGet200Response, Error<ApiV1NotificationsPreferencesGetError>> {

    let uri_str = format!("{}/api/v1/notifications/preferences", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1NotificationsPreferencesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_notifications_preferences_patch(configuration: &configuration::Configuration, notification_preferences: models::NotificationPreferences) -> Result<models::ApiV1NotificationsPreferencesGet200Response, Error<ApiV1NotificationsPreferencesPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1NotificationsPreferencesPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_notifications_stream_get(configuration: &configuration::Configuration, ) -> Result<String, Error<ApiV1NotificationsStreamGetError>> {
...
pub async fn api_v1_notifications_unread_count_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1NotificationsUnreadCountGet200Response, Error<ApiV1NotificationsUnreadCountGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1NotificationsUnreadCountGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_stars_sync_post(configuration: &configuration::Configuration, sync_stars_request: models::SyncStarsRequest) -> Result<models::ApiV1StarsSyncPost200Response, Error<ApiV1StarsSyncPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn api_v1_users_me_delete(configuration: &configuration::Configuration, ) -> Result<models::ApiV1UsersMeDelete200Response, Error<ApiV1UsersMeDeleteError>> {
...
pub async fn api_v1_users_me_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1UsersMeGet200Response, Error<ApiV1UsersMeGetError>> {
...
pub async fn api_v1_users_me_patch(configuration: &configuration::Configuration, update_profile_request: models::UpdateProfileRequest) -> Result<String, Error<ApiV1UsersMePatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn api_v1_users_me_stars_get(configuration: &configuration::Configuration, ) -> Result<models::ApiV1UsersMeStarsGet200Response, Error<ApiV1UsersMeStarsGetError>> {
...
pub async fn api_v1_users_username_collections_get(configuration: &configuration::Configuration, username: &str) -> Result<models::ApiV1CollectionsGet200Response, Error<ApiV1UsersUsernameCollectionsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_username = username;

    let uri_str = format!("{}/api/v1/users/{username}/collections", configuration.base_path, username=crate::apis::urlencode(p_path_username));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1UsersUsernameCollectionsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn api_v1_users_username_get(configuration: &configuration::Configuration, username: &str) -> Result<models::ApiV1UsersMeGet200Response, Error<ApiV1UsersUsernameGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_username = username;

    let uri_str = format!("{}/api/v1/users/{username}", configuration.base_path, username=crate::apis::urlencode(p_path_username));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn api_v1_users_username_modules_get(configuration: &configuration::Configuration, username: &str) -> Result<models::ApiV1ModulesGet200Response, Error<ApiV1UsersUsernameModulesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_username = username;

    let uri_str = format!("{}/api/v1/users/{username}/modules", configuration.base_path, username=crate::apis::urlencode(p_path_username));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn packages_uuid_version_filename_get(configuration: &configuration::Configuration, uuid: &str, version: &str, filename: &str) -> Result<reqwest::Response, Error<PackagesUuidVersionFilenameGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_path_version = version;
    let p_path_filename = filename;

    let uri_str = format!("{}/packages/{uuid}/{version}/{filename}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid), version=crate::apis::urlencode(p_path_version), filename=crate::apis::urlencode(p_path_filename));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PackagesUuidVersionFilenameGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn screenshots_uuid_filename_get(configuration: &configuration::Configuration, uuid: &str, filename: &str) -> Result<reqwest::Response, Error<ScreenshotsUuidFilenameGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_path_filename = filename;

    let uri_str = format!("{}/screenshots/{uuid}/{filename}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid), filename=crate::apis::urlencode(p_path_filename));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn security_check_get(configuration: &configuration::Configuration, uuid: &str, version: &str) -> Result<models::SecurityCheckGet200Response, Error<SecurityCheckGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
